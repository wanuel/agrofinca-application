...
public class SociedadResource {
    ...
    public SociedadResource(SociedadService sociedadService) {
    ...
    public ResponseEntity<List<Sociedad>> getAllSociedads(Pageable pageable) {
        log.debug("REST request to get a page of Sociedads");
        Page<Sociedad> page = sociedadService.findAll(pageable);
