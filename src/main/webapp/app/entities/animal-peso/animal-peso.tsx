...
import { getSearchEntities, getEntities } from './animal-peso.reducer';
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('agrofincaApp.animalPeso.home.search')}
                />
            ...
            <tbody>
              {animalPesoList.map((animalPeso, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{animalPeso.animal ? <Link to={`animal-evento/${animalPeso.animal.id}`}>{animalPeso.animal.id}</Link> : ''}</td>
