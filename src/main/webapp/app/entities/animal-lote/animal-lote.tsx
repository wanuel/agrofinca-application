...
import { getSearchEntities, getEntities } from './animal-lote.reducer';
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('agrofincaApp.animalLote.home.search')}
                />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('fechaIngreso')}>
                  <Translate contentKey="agrofincaApp.animalLote.fechaIngreso">Fecha Ingreso</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {animalLoteList.map((animalLote, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {animalLote.fechaIngreso ? (
                      <TextFormat type="date" value={animalLote.fechaIngreso} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{animalLote.animal ? <Link to={`animal/${animalLote.animal.id}`}>{animalLote.animal.id}</Link> : ''}</td>
