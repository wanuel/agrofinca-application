...
import { getSearchEntities, getEntities } from './evento.reducer';
  ...
  return (
    <div>
      <h2 id="evento-heading">
        <Translate contentKey="agrofincaApp.evento.home.title">Eventos</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="agrofincaApp.evento.home.createLabel">Create new Evento</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('agrofincaApp.evento.home.search')}
                />
        ...
        {eventoList && eventoList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('fecha')}>
                  <Translate contentKey="agrofincaApp.evento.fecha">Fecha</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('observacion')}>
                  <Translate contentKey="agrofincaApp.evento.observacion">Observacion</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="agrofincaApp.evento.evento">Evento</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="agrofincaApp.evento.home.notFound">No Eventos found</Translate>
            </div>
          )
        )}
      </div>
